...
class SaveToNdexButton(Component):
    """A SaveToNdexButton component.
...
- value (string; optional): The value displayed in the input."""
    ...
    def __init__(self, id=Component.UNDEFINED, label=Component.REQUIRED, value=Component.UNDEFINED, **kwargs):
        ...
        self._type = 'SaveToNdexButton'
        self._namespace = 'save_to_ndex_button'
        ...
        super(SaveToNdexButton, self).__init__(**args)
